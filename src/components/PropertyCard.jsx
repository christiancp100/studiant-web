...
const PropertyCard = ({ property, id }) => {
  ...
  return <div onClick={() => router.push(`/pisos/${id}`)} className="flex flex-col justify-between shadow-lg rounded-xl cursor-pointer h-96">
    <div className="relative w-full h-64">
      <Image src={img} layout="fill" className="rounded-t-xl" objectFit="cover" />
    </div>
